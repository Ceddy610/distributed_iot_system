...
public final class DatabaseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.rpc.Database.saveRttRequest,
      org.rpc.Database.rttDataResponse> getSaveRttMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "saveRtt",
      requestType = org.rpc.Database.saveRttRequest.class,
      responseType = org.rpc.Database.rttDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.rpc.Database.saveRttRequest,
      org.rpc.Database.rttDataResponse> getSaveRttMethod() {
    io.grpc.MethodDescriptor<org.rpc.Database.saveRttRequest, org.rpc.Database.rttDataResponse> getSaveRttMethod;
    if ((getSaveRttMethod = DatabaseServiceGrpc.getSaveRttMethod) == null) {
      synchronized (DatabaseServiceGrpc.class) {
        if ((getSaveRttMethod = DatabaseServiceGrpc.getSaveRttMethod) == null) {
          DatabaseServiceGrpc.getSaveRttMethod = getSaveRttMethod =
              io.grpc.MethodDescriptor.<org.rpc.Database.saveRttRequest, org.rpc.Database.rttDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.rpc.Database.rttDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.rpc.Database.getRttRequest,
      org.rpc.Database.rttDataResponse> getGetRttMethod;
  ...
  public static io.grpc.MethodDescriptor<org.rpc.Database.getRttRequest,
      org.rpc.Database.rttDataResponse> getGetRttMethod() {
    io.grpc.MethodDescriptor<org.rpc.Database.getRttRequest, org.rpc.Database.rttDataResponse> getGetRttMethod;
    if ((getGetRttMethod = DatabaseServiceGrpc.getGetRttMethod) == null) {
      synchronized (DatabaseServiceGrpc.class) {
        if ((getGetRttMethod = DatabaseServiceGrpc.getGetRttMethod) == null) {
          DatabaseServiceGrpc.getGetRttMethod = getGetRttMethod =
              io.grpc.MethodDescriptor.<org.rpc.Database.getRttRequest, org.rpc.Database.rttDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class DatabaseServiceImplBase implements io.grpc.BindableService {
    ...
    public void saveRtt(org.rpc.Database.saveRttRequest request,
        io.grpc.stub.StreamObserver<org.rpc.Database.rttDataResponse> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                org.rpc.Database.rttDataResponse>(
  ...
  public static final class DatabaseServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DatabaseServiceBlockingStub> {
    ...
    /**
     */
    public org.rpc.Database.rttDataResponse saveRtt(org.rpc.Database.saveRttRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public org.rpc.Database.rttDataResponse getRtt(org.rpc.Database.getRttRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class DatabaseServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DatabaseServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.rpc.Database.rttDataResponse> saveRtt(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.rpc.Database.rttDataResponse> getRtt(
